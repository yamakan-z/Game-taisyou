...
void CSceneMain::InitScene()
{
	...
	Draw::LoadImageW(L"空白欄(緑).png", 18, TEX_SIZE_1024);
	Draw::LoadImageW(L"空白欄(黄).png", 19, TEX_SIZE_1024);
	Draw::LoadImageW(L"空白欄(赤).png", 20, TEX_SIZE_1024);
	Draw::LoadImageW(L"空白欄(赤)バツ印.png", 21, TEX_SIZE_1024);
	Draw::LoadImageW(L"インベントリ(劣化).png", 22, TEX_SIZE_512);
	Draw::LoadImageW(L"はしごアイテム(劣化).png", 23, TEX_SIZE_512);
	Draw::LoadImageW(L"つるはし(劣化).png", 24, TEX_SIZE_512);
	Draw::LoadImageW(L"鉄板3.png", 25, TEX_SIZE_512);
	Draw::LoadImageW(L"はしご看板.png", 26, TEX_SIZE_1024);
	Draw::LoadImageW(L"つるはし看板.png", 27, TEX_SIZE_512);
	Draw::LoadImageW(L"鉄板看板.png", 28, TEX_SIZE_512);
	Draw::LoadImageW(L"劣化はしご看板.png", 29, TEX_SIZE_512);
	Draw::LoadImageW(L"劣化つるはし看板.png", 30, TEX_SIZE_512);
	Draw::LoadImageW(L"劣化鉄板看板.png", 31, TEX_SIZE_512);
	Draw::LoadImageW(L"看板棒.png", 32, TEX_SIZE_512);
	//アイテム数番号
