...
void CSceneMainT::InitScene()
{
	...
	Draw::LoadImageW(L"背景4.png", 2, TEX_SIZE_1024);
	...
	Draw::LoadImageW(L"説明画面T.png", 19, TEX_SIZE_512);
	...
	Audio::LoadAudio(9, L"説明画面開.wav", SOUND_TYPE::EFFECT);
	Audio::LoadAudio(10, L"説明画面止.wav", SOUND_TYPE::EFFECT);
